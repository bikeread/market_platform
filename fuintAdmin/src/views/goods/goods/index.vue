  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" class="main-search" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="可用平台" prop="platform">
        ...
        >
          ...
          <el-option key="1" label="仅会员端" value="1" />
          <el-option key="2" label="仅收银端" value="2" />
        </el-select>
      </el-form-item>
      ...
      <el-form-item>
        ...
        <div class="download-template" @click="download('/backendApi/goods/goods/downloadTemplate')">下载导入模板</div>
      </el-form-item>
    </el-form>
    ...
    <el-table ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
      ...
      <el-table-column label="所属分类" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.cateInfo ? scope.row.cateInfo.name : '-' }}</span>
        </template>
      </el-table-column>
