  ...
  <div class="app-container">
    ...
    <el-table ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
      ...
      <el-table-column label="核销金额" align="center" prop="amount">
         <template slot-scope="scope">
             <span v-if="scope.row.amount" style="color:red">
                <span v-if="scope.row.couponInfo.content=='2'">{{ (scope.row.amount / 10).toFixed(2) }}折</span>
      ...
      <el-table-column label="操作" align="center" width="68" fixed="right">
        <template slot-scope="scope">
          <el-button
            size="mini"
            type="text"
