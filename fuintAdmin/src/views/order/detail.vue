    ...
    <div class="main-panel" v-loading="loading">
          ...
          <div class="content">
            ...
            <el-row class="row">
              ...
              <el-col :span="8">
                ...
                <span v-if="orderInfo.couponInfo && orderInfo.couponInfo.content == '2'" class="control-label">{{ orderInfo.couponInfo ? (orderInfo.couponInfo.amount / 10).toFixed(2) + '折（' + orderInfo.couponInfo.name + '）' : '--' }}</span>
                <span v-else class="control-label">{{ orderInfo.couponInfo ? '￥' + orderInfo.couponInfo.amount + '（' + orderInfo.couponInfo.name + '）' : '--' }}</span>
              </el-col>
            </el-row>
            <el-row class="row">
              <el-col :span="8">
              ...
              <el-col :span="8">
                ...
                <span class="control-label">￥{{ orderInfo.deliveryFee ? orderInfo.deliveryFee.toFixed(2) : '-' }}</span>
              </el-col>
            </el-row>
          </div>
        </div>
        ...
        <div class="panel" v-if="orderInfo.type=='goods'">
          ...
          <div class="content">
            ...
            <el-row class="row" v-if="orderInfo.orderMode == 'oneself'">
              <el-col :span="8">
                <span class="head">核销状态：</span>
                <span class="control-label" v-if="orderInfo.confirmStatus == 'Y'">已核销</span>
                <span class="control-label" v-else>未核销</span>
              </el-col>
              <el-col :span="8">
                <span class="head">核销时间：</span>
                <span class="control-label">{{orderInfo.confirmTime ? orderInfo.confirmTime : '-'}}</span>
              </el-col>
              <el-col :span="8">
                <span class="head">核销备注：</span>
                <span class="control-label">{{orderInfo.confirmRemark ? orderInfo.confirmRemark : '-'}}</span>
              </el-col>
            </el-row>
          </div>
        </div>
