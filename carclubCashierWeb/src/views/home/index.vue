<template>
  <div id="app" class="app-container">
    <el-drawer
      ...
      <div class="main">
         <div class="tool">
           <div class="item" @click="target('/cashier/index')"><i class="el-icon-user"></i>进入收银</div>
           <div class="item" @click="target('/setting/cashier')"><i class="el-icon-setting"></i>系统设置</div>
