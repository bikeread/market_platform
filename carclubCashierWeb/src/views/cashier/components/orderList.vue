        ...
        <template slot-scope="scope">
          ...
          <el-dropdown size="mini" @command="(command) => handleCommand(command, scope.row)">
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item command="handlePrint" icon="el-icon-printer">打印小票</el-dropdown-item>
              <el-dropdown-item command="handlePay" v-if="scope.row.payStatus != 'B'" icon="el-icon-wallet">发起支付</el-dropdown-item>
...
<script>
import { getName } from "@/utils/carclub";
