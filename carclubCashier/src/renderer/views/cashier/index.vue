       ...
       <div class="main">
         ...
         <div class="left-side">
           <div class="logo">
             ...
             <div class="account">您好，{{ accountInfo.realName ? accountInfo.realName : accountInfo.accountName }}！</div>
           </div>
           <div class="cate">
             <ul class="nav">
...
export default {
  ...
  data() {
    return {
      ...
      confirmCoupon: false,
      // 商品模式
      goodsMode: localStorage.getItem("goodsMode") ? localStorage.getItem("goodsMode") : 'small'
    };
  },
  mounted() {
    const app = this;
  ...
  methods: {
    ...
    // 商品模式切换
    switchGoodMode(mode) {
      localStorage.setItem("goodsMode", mode);
      this.goodsMode = mode;
      let size = 15;
      if (mode == 'big') {
          size = 9;
      }
      this.switchTab({ limit: size });
    },
    // 弹出关联员工
    bindStaff() {
