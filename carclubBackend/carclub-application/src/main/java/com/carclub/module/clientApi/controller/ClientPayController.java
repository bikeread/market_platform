...
import com.carclub.common.enums.OrderStatusEnum;
...
public class ClientPayController extends BaseController {
    ...
    public ResponseObject prePay(HttpServletRequest request) throws BusinessCheckException {
        ...
        if (mtUser != null && !mtUser.getIsStaff().equals(YesOrNoEnum.YES.getKey()) && !mtUser.getIsStaff().equals(YesOrNoEnum.YES.getKey())) {
