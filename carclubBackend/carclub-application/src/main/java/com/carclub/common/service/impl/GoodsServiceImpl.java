...
import com.carclub.common.dto.GoodsDto;
import com.carclub.common.dto.GoodsSpecValueDto;
import com.carclub.common.dto.GoodsTopDto;
import com.carclub.common.enums.GoodsTypeEnum;
import com.carclub.common.enums.PlatformTypeEnum;
import com.carclub.common.enums.StatusEnum;
import com.carclub.common.enums.YesOrNoEnum;
import com.carclub.common.service.*;
import com.carclub.common.util.SeqUtil;
import com.carclub.common.util.XlsUtil;
import com.carclub.framework.annoation.OperationServiceLog;
...
import com.carclub.repository.mapper.MtGoodsSkuMapper;
import com.carclub.repository.mapper.MtGoodsSpecMapper;
import com.carclub.repository.mapper.MtStoreGoodsMapper;
                ...
                if (mtGoods != null) {
                    ...
                    if (mtGoods.getIsSingleSpec().equals(YesOrNoEnum.NO.getKey())) {
                        ...
                        if (StringUtil.isNotEmpty(sku.get(1))) {
                            ...
                            Integer stock = Integer.parseInt(sku.get(6));
