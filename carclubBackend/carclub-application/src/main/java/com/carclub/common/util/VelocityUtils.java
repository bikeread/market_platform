...
import com.carclub.repository.bean.ColumnBean;
...
public class VelocityUtils {
    ...
    /** 数据库项目路径 */
    private static final String REPOSITORY_PATH = "/carclub-repository/src/main";

    /** mapper路径 */
    private static final String MAPPER_PATH = "/java/com/carclub/repository/mapper";

    /** model路径 */
    private static final String MODEL_PATH = "/java/com/carclub/repository/model";

    /** mybatis xml路径 */
    private static final String MAPPER_XML_PATH = "/resources/mapper";

    /** 接口服务路径 */
    private static final String SERVICE_PATH = "/carclub-application/src/main/java/com/carclub/common/service";

    /** 控制器路径 */
    private static final String CONTROLLER_PATH = "/carclub-application/src/main/java/com/carclub/module/backendApi/controller";
