package com.carclub.common.service.impl;
...
import com.carclub.common.bean.H5SceneInfo;
import com.carclub.common.bean.WxPayBean;
import com.carclub.common.bean.shoppingOrders.*;
import com.carclub.common.dto.OrderDto;
import com.carclub.common.dto.UserOrderDto;
import com.carclub.common.dto.WxCardDto;
import com.carclub.common.enums.*;
import com.carclub.common.http.HttpRESTDataClient;
import com.carclub.common.service.*;
import com.carclub.common.util.*;
import com.carclub.common.vo.printer.OrderStatusType;
import com.carclub.framework.exception.BusinessCheckException;
import com.carclub.framework.web.ResponseObject;
import com.carclub.repository.mapper.MtGoodsMapper;
import com.carclub.repository.mapper.MtOrderGoodsMapper;
import com.carclub.repository.mapper.MtUploadShippingLogMapper;
import com.carclub.repository.model.*;
import com.carclub.utils.QRCodeUtil;
...
public class WeixinServiceImpl implements WeixinService {
    ...
    private static final String CARCLUB_ACCESS_TOKEN_PRE = "CARCLUB_ACCESS_TOKEN";
    ...
    public String getAccessToken(Integer merchantId, boolean isMinApp, boolean useCache) throws BusinessCheckException {
        ...
        String tokenKey = CARCLUB_ACCESS_TOKEN_PRE + platForm;
        ...
        try {
            ...
            if (data.get("errcode").toString().equals("0")) {
                ...
                try {
                    ...
                    com.carclub.common.util.QRCodeUtil.createQrCode(out, content, 800, 800, "png", "");
                    // 对数据进行Base64编码
