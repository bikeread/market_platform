    ...
    methods: {
      ...
      switchVehicle() {
        if (this.vehicleList < 1 ) {
          this.$navTo('pagesA/vehicle/index?action=switch');
        } else {
...
<style lang="scss" scoped>
  ...
  .row-textarea {
    ...
    .textarea {
      ...
      min-height: 220rpx;
      padding: 20rpx;
      border: 1rpx solid $carclub-theme;
      padding: 10rpx;
      border-radius: 5rpx;
  ...
  .popup__coupon {
    ...
    .item-wrapper {
      ...
      &.color-default {
        background: linear-gradient(-128deg, $carclub-theme, $carclub-theme);
      }
  ...
  .footer-fixed {
    ...
    .btn-item-main {
      background: linear-gradient(to right, $carclub-theme, $carclub-theme);
      // 禁用按钮
      &.disabled {
        background: #cccccc;
      }
