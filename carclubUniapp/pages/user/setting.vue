        ...
        <view class="contacts">
          ...
          <view class="value">
             <radio-group @change="genderChange">
                <label class="radio"><radio value="1" color="#373F64" :checked="userInfo.sex == '1' ? true : false"/>男</label>
                <label class="radio second"><radio value="0" color="#373F64" :checked="userInfo.sex == '0' ? true: false"/>女</label>
             </radio-group>
          </view>
        </view>
      </view>
...
<style lang="scss" scoped>
  ...
  .footer-fixed {
    ...
    .btn-item-out {
      margin-top: 20rpx;
      background: #FFFFFF;
      border: 1px solid $carclub-theme;
      color: #666666;
    }
