        ...
        <el-tab-pane label="扩展信息" name="extend">
          <div class="content">
            <el-form ref="extendForm" :model="extendForm" :rules="extendRules" label-width="120px">
              ...
              <el-row>
                <el-col :span="24">
                  <el-form-item label="可用平台" prop="platform">
                    <el-radio-group v-model="extendForm.platform">
                      <el-radio key="0" label="0" value="0">不限制</el-radio>
                      <el-radio key="1" label="1" value="1">仅会员端</el-radio>
                      <el-radio key="2" label="2" value="2">仅收银端</el-radio>
                    </el-radio-group>
                  </el-form-item>
                </el-col>
              </el-row>
              ...
              <el-row v-if="extendForm.isSingleSpec == 'Y'">
                <el-col :span="24">
                  <el-form-item label="划线价格" prop="linePrice">
                    <el-input v-model="extendForm.linePrice" class="min-input" placeholder="请输入商品划线价格（市场价），空则不显示" maxlength="50" />
                    <div class="form-tips">单位：元</div>
                  </el-form-item>
                </el-col>
              </el-row>
...
export default {
  ...
  data() {
    return {
      ...
      // 基础信息表单
      baseForm: { type: 'goods', goodsId: '', name: '', storeId: (this.$store.getters.storeId ? [ this.$store.getters.storeId ] : []), cateId: '', goodsNo: '', images: [], status: "A", sort: 0 },
      // 扩展信息表单
      extendForm: { goodsId: '', canUsePoint: 'Y', isMemberDiscount: 'Y', platform: '0', isSingleSpec: 'Y', serviceTime: 0, couponIds: '', stock: '', price: '', linePrice: '', costPrice: '', salePoint: '', initSale: '', weight: '', skuData: null },
      // 详情信息表单
    ...
    getGoodsInfo(goodsId) {
      ...
      getGoodsInfo(goodsId).then(response => {
          ...
          if (goodsInfo) {
              ...
              this.extendForm.costPrice = goodsInfo.costPrice;
              ...
              this.extendForm.platform = goodsInfo.platform+''
