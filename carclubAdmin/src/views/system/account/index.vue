...
export default {
  ...
  created() {
    this.queryParams.merchantId = this.$route.query.merchantId ? this.$route.query.merchantId : '';
    this.queryParams.storeId = this.$route.query.storeId ? this.$route.query.storeId : '';
    this.queryParams.staffId = this.$route.query.staffId ? this.$route.query.staffId : '';
    this.getList();
  },
  activated() {
    this.queryParams.merchantId = this.$route.query.merchantId ? this.$route.query.merchantId : '';
  ...
  methods: {
    ...
    handleAdd() {
      const app = this;
      app.reset();
      app.form.merchantId = app.queryParams.merchantId ? parseInt(app.queryParams.merchantId) : '';
      app.form.storeId = 0;
      app.form.staffId = '';
