  ...
  <div class="app-container">
    <el-form :model="queryParams" class="main-search" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item>
        ...
        >新增</el-button>
        <el-button type="primary" icon="el-icon-setting" size="mini" v-hasPermi="['printer:setting']" @click="handleSetting">设置</el-button>
      </el-form-item>
    </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      // 表单参数
      form: { id: '', name: '', sn: '', autoPrint: 'Y', storeId: 0,  status: "A", sort: 0 },
      // 店铺列表
      storeList: [],
      // 查询参数
      queryParams: {
