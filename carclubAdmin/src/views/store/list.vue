  ...
  <div class="app-container">
    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-row v-hasPermi="['store:paySetting']">
          <el-col :span="24">
            <el-form-item label="微信支付APIv2" prop="wxApiV2">
              <el-input
        ...
        <el-row v-hasPermi="['store:paySetting']">
          <el-col :span="24">
            <el-form-item label="微信支付证书" prop="wxCertPath">
              ...
              <div class="form-tips">(提示：必须是.p12格式)</div>
              <el-button type="danger" style="margin-left: 0px;" v-if="wxCertPath" @click="removeWxCert" icon="el-icon-delete" size="mini">删除</el-button>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row v-hasPermi="['store:paySetting']">
          ...
          <el-col :span="24">
            <el-form-item label="支付宝公钥" prop="alipayPublicKey">
              <el-input
                ...
                placeholder="请输入支付宝公钥，为空则资金进入平台账户"
                maxlength="10000"
              />
            </el-form-item>
          </el-col>
    ...
    <CarclubQrCode :showDialog="openQrCode" :qr="qr" @closeDialog="closeDialog" />
  </div>
</template>
