      ...
      <div class="overview">
          ...
          <div class="content">
            <el-row class="line home-tools">
                <el-col class="item no-border" :span="8"><div class="do" @click="toCashier('/carclubCarCashier/')"><img class="t-icon" src="@/assets/images/home/pay.png"><div class="text">收银开单</div></div></el-col>
